...
import { NationalInsuranceCalculator } from '../components/calculators/NationalInsuranceCalculator';
...
export const NationalInsurancePage: React.FC = () => {
  const content = CALCULATOR_CONTENT_CONFIG.national_insurance;
  const breadcrumbs = [
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <FaqAccordion items={content.faqs} title="Frequently Asked Questions about National Insurance" />
      <DisclaimerNotice />
    </div>
  );
};
