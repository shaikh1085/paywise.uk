...
import { MortgageOverpaymentCalculator } from '../components/calculators/MortgageOverpaymentCalculator';
...
export const MortgageOverpaymentPage: React.FC = () => {
  const content = CALCULATOR_CONTENT_CONFIG['mortgage_overpayment'];

  const breadcrumbs = [
    { label: 'Calculators', path: '/salary-calculators' },
    { label: 'Mortgage Overpayment Calculator UK', path: '/mortgage-overpayment-calculator' },
  ];
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="max-w-3xl space-y-2">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-[#F5F5F5] dark:bg-[#171717] border border-[#E5E5E5] dark:border-[#2A2A2A] text-[#059669] dark:text-[#10B981] text-xs font-bold shadow-xs">
          ...
          UK Mortgage Interest Calculator {TAX_CONFIG_METADATA.currentTaxYearLabel}
        </div>
        ...
        {content.relatedCalculators && content.relatedCalculators.length > 0 && (
          <div className="pt-4 border-t border-[#E5E5E5] dark:border-[#2A2A2A] space-y-3">
            <h3 className="text-base font-bold text-[#111111] dark:text-[#F5F5F5]">
              Related UK Property & Mortgage Calculators
            </h3>
      ...
      {/* FAQs Section */}
      <FaqAccordion items={content.faqs} title="Frequently Asked Questions about Mortgage Overpayments" />
