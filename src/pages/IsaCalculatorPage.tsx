...
import { IsaCalculator } from '../components/calculators/IsaCalculator';
...
export const IsaCalculatorPage: React.FC = () => {
  const content = CALCULATOR_CONTENT_CONFIG.isa;
  const breadcrumbs = [
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="max-w-3xl space-y-2">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-[#F5F5F5] dark:bg-[#171717] border border-[#E5E5E5] dark:border-[#2A2A2A] text-[#059669] dark:text-[#10B981] text-xs font-bold shadow-xs">
          ...
          Updated for UK Tax Year {TAX_CONFIG_METADATA.currentTaxYearLabel} (£20,000 Annual Allowance)
        </div>
      ...
      <FaqAccordion items={content.faqs} title="Frequently Asked Questions about UK ISAs" />
      <DisclaimerNotice />
    </div>
  );
};
