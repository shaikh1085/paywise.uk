...
Calculated via PayWise UK (https://www.paywiseuk.co.uk/mortgage-calculator)`;
      ...
      <div className="lg:col-span-7 space-y-6">
        ...
        <div className="rounded-3xl bg-[#111111] text-white p-6 sm:p-8 border border-[#2A2A2A] shadow-xl relative overflow-hidden">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs text-slate-400 font-semibold">{input.repaymentType === 'repayment' ? 'Repayment' : 'Interest-Only'}</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-center mb-6">
            <div className="sm:col-span-8 space-y-1">
              <div className="text-3xl sm:text-5xl font-black text-white flex items-baseline gap-1 tracking-tight">
                <AnimatedNumber value={result.monthlyPayment} prefix="£" decimals={2} />
                <span className="text-sm font-bold text-slate-400">/mo</span>
              </div>
              <p className="text-xs sm:text-sm text-slate-300 flex items-center gap-1.5 pt-1">
                <span>
                  Annual payment: <strong className="text-white">£{result.annualPayment.toLocaleString('en-GB', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</strong>
                </span>
              </p>
            </div>
            ...
            <div className="sm:col-span-4 flex justify-start sm:justify-end">
              <div className="text-center p-3 rounded-2xl bg-white/5 border border-white/10">
                <span className="text-2xs text-slate-400 uppercase font-bold block">Loan Amount</span>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-5 border-t border-slate-800">
            <div className="bg-[#171717] p-3.5 rounded-2xl border border-white/5">
              <span className="text-2xs uppercase text-slate-400 font-bold block truncate">Loan to Value</span>
            ...
            <div className="bg-[#171717] p-3.5 rounded-2xl border border-white/5">
              <span className="text-2xs uppercase text-slate-400 font-bold block truncate">Total Interest</span>
            ...
            <div className="bg-[#171717] p-3.5 rounded-2xl border border-white/5 col-span-2 sm:col-span-1">
              <span className="text-2xs uppercase text-slate-400 font-bold block truncate">Total Repaid</span>
