...
Calculated via PayWise UK (https://www.paywiseuk.co.uk/bonus-tax-calculator)`;
      ...
      <div className="lg:col-span-7 space-y-6">
        ...
        <div className="relative rounded-2xl bg-gradient-to-br from-[#111111] via-[#1A1A1A] to-[#111111] dark:from-[#0F0F0F] dark:via-[#171717] dark:to-[#0A0A0A] text-white p-6 sm:p-7 border border-[#2A2A2A] shadow-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-center mb-6">
            <div className="sm:col-span-8 space-y-1">
              ...
              <p className="text-xs text-[#D4D4D4] pt-1">
                From a gross bonus of <strong className="text-white">£{result.bonusAmount.toLocaleString('en-GB')}</strong> (Total Deductions: £{result.totalDeductionsOnBonus.toLocaleString('en-GB', { minimumFractionDigits: 2, maximumFractionDigits: 2 })})
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-4 border-t border-[#2A2A2A] text-xs">
            <div>
              <span className="text-[#A3A3A3] block text-2xs uppercase">Income Tax</span>
            ...
            <div>
              <span className="text-[#A3A3A3] block text-2xs uppercase">National Insurance</span>
              <span className="font-bold text-[#EF4444] tabular-nums">
                -£{result.niOnBonus.toLocaleString('en-GB', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}
              </span>
            </div>
            <div>
              <span className="text-[#A3A3A3] block text-2xs uppercase">Pension Contrib.</span>
            ...
            <div>
              <span className="text-[#A3A3A3] block text-2xs uppercase">Student Loan</span>
              <span className="font-bold text-white tabular-nums">
