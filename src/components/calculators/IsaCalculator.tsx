...
Calculated via PayWise UK (https://www.paywiseuk.co.uk/isa-calculator)`;
      ...
      <div className="lg:col-span-7 space-y-6">
        ...
        <div className="rounded-3xl bg-[#111111] text-white p-6 sm:p-8 border border-[#2A2A2A] shadow-xl relative overflow-hidden">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs text-slate-400 font-semibold">{input.timePeriodYears} Years</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-center mb-6">
            <div className="sm:col-span-8 space-y-1">
              <div className="text-3xl sm:text-5xl font-black text-white flex items-baseline gap-1 tracking-tight">
                <AnimatedNumber value={result.projectedEndingBalance} prefix="£" decimals={2} />
              </div>
              <p className="text-xs sm:text-sm text-slate-300 flex items-center gap-1.5 pt-1">
                <TrendingUp className="w-4 h-4 text-emerald-400 shrink-0" />
                <span>
                  Total Growth: <strong className="text-emerald-400">£{result.totalGrowth.toLocaleString('en-GB', { minimumFractionDigits: 2 })}</strong>
                </span>
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-5 border-t border-slate-800">
            <div className="bg-[#171717] p-3.5 rounded-2xl border border-white/5">
              <span className="text-2xs uppercase text-slate-400 font-bold block truncate">Total Deposited</span>
            ...
            <div className="bg-[#171717] p-3.5 rounded-2xl border border-white/5">
              <span className="text-2xs uppercase text-slate-400 font-bold block truncate">Allowance Status</span>
            ...
            <div className="bg-[#171717] p-3.5 rounded-2xl border border-white/5 col-span-2 sm:col-span-1">
              <span className="text-2xs uppercase text-slate-400 font-bold block truncate">Allowance Left</span>
