...
Calculated via PayWise UK (https://www.paywiseuk.co.uk/pay-rise-calculator)`;
        ...
        <div className="relative rounded-2xl bg-gradient-to-br from-[#111111] via-[#1A1A1A] to-[#111111] dark:from-[#0F0F0F] dark:via-[#171717] dark:to-[#0A0A0A] text-white p-6 sm:p-7 border border-[#2A2A2A] shadow-xl">
          <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
            ...
            <span className="text-xs text-[#A3A3A3]">
              Pay Rise Retention: <strong className="text-white">{result.takeHomeRetentionPercent.toFixed(1)}%</strong>
            </span>
          </div>
            ...
            <div className="sm:col-span-8 space-y-1">
              <div className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white">
                +<AnimatedNumber
                  ...
                  decimals={2}
                />
                <span className="text-sm sm:text-base font-normal text-[#A3A3A3] ml-2">/ month</span>
              </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-4 border-t border-[#2A2A2A] text-xs">
            <div>
              <span className="text-[#A3A3A3] block text-2xs uppercase">Gross Pay Rise</span>
              <span className="font-bold text-white tabular-nums">
                +£{result.grossIncreaseAnnual.toLocaleString('en-GB')}
              </span>
            </div>
            <div>
              <span className="text-[#A3A3A3] block text-2xs uppercase">Extra Deductions</span>
            ...
            <div>
              <span className="text-[#A3A3A3] block text-2xs uppercase">New Marginal Rate</span>
              <span className="font-bold text-[#10B981] tabular-nums">
                {result.newMarginalTaxRate.toFixed(1)}%
              </span>
            </div>
            <div>
              <span className="text-[#A3A3A3] block text-2xs uppercase">Effective Tax Rate</span>
              <span className="font-bold text-white tabular-nums">
