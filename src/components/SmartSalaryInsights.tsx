...
export const SmartSalaryInsights: React.FC<SmartSalaryInsightsProps> = ({ input, result }) => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 p-3.5 rounded-xl bg-white dark:bg-[#111111] border border-[#E5E5E5] dark:border-[#2A2A2A] shadow-2xs flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-2">
        ...
        <div className="text-xs font-bold text-[#111111] dark:text-[#F5F5F5] tabular-nums">
          Effective deduction rate: <span className="text-[#111111] dark:text-[#F5F5F5] font-black">{insights.mainDeductions.effectiveRateFormatted}</span>
        </div>
      </div>
