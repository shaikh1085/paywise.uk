...
export const UK_NATIONAL_INSURANCE_CONFIGS: Record<string, NationalInsuranceYearConfig> = {
  ...
  '2025_26': {
    ...
    notes: 'Autumn Budget 2024 changes take effect: Employer NI increased to 15% and Secondary Threshold reduced to £5,000. Employment Allowance raised to £10,500.',
  },
  '2026_27': {
    ...
    notes: 'Projected rates based on legislated UK statutory provisions.',
  },
};
